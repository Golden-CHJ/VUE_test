      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li  v-for="(item,index) in addressFilter" :key="item" v-bind:class="{'check': checkIndex == index}" @click="checkIndex=index">
                  <dl>
                    <dt >{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-del">
                    <!-- 删除地址 -->
                    <a href="javascript:;" class="addr-del-btn" @click="delcomfirm">
                  ...
                  <div class="addr-opration addr-set-default">
                    <a href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault"  @click="setAdd(item.addressId)"><i>设为默认</i></a>
                  </div>
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn open" href="javascript:;"  @click="expend">
                查看更多
                <i class="i-up-down">
